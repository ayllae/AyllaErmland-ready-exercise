...
####################
### Third model fit (by Aylla Ermland)

# fit linear model using height as outcome, body fat percentage and exercise type as predictors

lmfit3 <- lm(Height ~ Body_fat_percentage + Exercise_type, mydata)

# place results from fit into a data frame with the function
