...
The exampledata.xlsx is a worksheet with Height, Weight, Gender column information. I have recently added two columns called  "Body_fat_percentage" as numeric variable, and "Exercise_type" as categorical variable representing the type of exercise an individual perform (none, cardio, strength, mixed). 
